...
module.exports = {
  ...
  onStart: async function ({ api, event, args, usersData, threadsData }) {
    ...
    var name2 = "Uff ksto amaro jodi thakto🙈"; // Replace with function that retrieves the name of the user
    ...
    return api.sendMessage(
      {
        body: `🥰love birds! ${name1}\💌Wish you two hundred years of happiness💕${name2}.\—The love is ${tile}%`,
        mentions: [
          {
            tag: `${name2}`,
            id: id2,
